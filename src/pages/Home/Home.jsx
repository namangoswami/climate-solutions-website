...
const aboutData = [
  ...
  {
    description: 'GET HANDPICKED, QUALITY PRODUCTS AT UNBELIEVABLE RATES',
      ...
      <div className="home-backdrop-filter"></div>
        <div className="home-backdrop">
          <div className='home-title'>
            Best Home Appliances Accessories Store
          </div>
      ...
      <div className="section-books-sold">
        <div className="books-sold-grid row p-5 g-3 theme-bg">
          ...
          <div className="books-sold-grid-item col">
            <div className="books-sold-grid-item-value">10,000+</div>
