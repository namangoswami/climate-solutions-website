    ...
    <div className="about-container">
        <div className="about-section-1">
            <div className="about-section-1-text">
                <h1>Who we are</h1>
                <p>
                We are a company that works in Home Electronics Servicing.  
                </p>
            </div>
        ...
        <div className="about-section-2">
            <div className="about-section-2-text">
                ...
                <p>
                   It is our passion with technology that has driven us to make these products available to every part of India ❤️
                   </p>
            </div>
