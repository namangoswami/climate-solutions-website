      ...
      <div className="row">
        <div className="col-12 col-md-4">
          ...
          <div className="footer-content">
            <p>
              Climate Solutions is a service center located in New Delhi.
            </p>
      </div>
          </div>
          <div className="col-12 col-md-4">
            ...
            <div className="footer-content">
              <div className="footer-contact">
                ...
                <div className="footer-contact">
                  ...
                  <a href="mailto:help@climatesolutions@gmail.com" className="footer-contact-value">help@climatesolutions.in</a>
                  </div>
                  </div>
                  </div>
                  <div className="col-12 col-md-4">
